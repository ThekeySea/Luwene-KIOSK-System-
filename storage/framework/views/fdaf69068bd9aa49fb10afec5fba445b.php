        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
            <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-0.5"><?php echo e($tables->where('status', 'AVAILABLE')->count()); ?> kosong dari <?php echo e($tables->count()); ?> meja</p>
                </div>
            ...
            <div class="p-5 grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    <div class="group relative border-2 rounded-2xl p-4 text-center transition-all duration-200
                        ...
                        <p class="text-lg font-display font-bold <?php echo e($isOccupied ? 'text-red-700' : 'text-gray-900'); ?>">
                            <?php echo e($table->table_number); ?>

                        </p>

                        <div class="flex items-center justify-center gap-1 mt-1">
                            <svg class="w-3 h-3 <?php echo e($isOccupied ? 'text-red-400' : 'text-gray-400'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0" />
                            </svg>
                            <span class="text-xs font-medium <?php echo e($isOccupied ? 'text-red-500' : 'text-gray-500'); ?>"><?php echo e($table->capacity); ?> orang</span>
                        </div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isOccupied): ?>
                            <div class="mt-3 pt-3 border-t border-red-100">
                                <button
                                    ...
                                    <span wire:loading.remove wire:target="releaseTableById('<?php echo e($table->id); ?>')">
