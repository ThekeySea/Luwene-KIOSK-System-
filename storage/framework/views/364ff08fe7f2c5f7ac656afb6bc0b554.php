        ...
        <div class="w-full max-w-lg">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8">
                <form wire:submit="login">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->has('email') && !str_contains($errors->first('email'), 'salah')): ?>
                ...
                <div class="mt-6 text-center text-sm text-warm-500">
                    Belum punya akun?
                    <a href="<?php echo e(route('register')); ?>" class="text-primary font-semibold hover:underline">Daftar</a>
                </div>
            </div>
        </div>
    </div>
<?php /**PATH C:\laragon\www\Luwene\resources\views/livewire/auth/login.blade.php ENDPATH**/ ?>