<div wire:poll.15s>
    ...
    <div class="mb-6">
        <a href="<?php echo e(route('home')); ?>" target="_blank" class="flex items-center gap-4 bg-gradient-to-r from-primary to-accent rounded-xl p-5 text-white hover:shadow-lg hover:scale-[1.01] transition-all duration-200">
