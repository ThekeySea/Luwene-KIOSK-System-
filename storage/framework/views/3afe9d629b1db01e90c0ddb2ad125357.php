    ...
    >
        ...
        >
            ...
            <nav class="flex-1 py-3 px-2 space-y-1 overflow-y-auto" aria-label="Menu admin">
                    ...
                    $groups = [
                        [
                            'items' => [
                                ...
                                ['route' => 'admin.packages', 'label' => 'Paket', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" />'],
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $groups[0]['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <a
                    ...
                    >
                        ...
                        <svg class="w-5 h-5 shrink-0 <?php echo e(request()->routeIs($item['route']) ? 'text-accent' : 'text-white/70 group-hover:text-white'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <?php echo $item['icon']; ?>
            ...
            <a href="<?php echo e(route('home')); ?>" target="_blank" class="flex items-center gap-3 mx-3 mb-1 px-3 py-2.5 rounded-lg text-sm font-medium text-accent hover:bg-white/10 transition focus:outline-none focus:ring-2 focus:ring-accent">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                </svg>
                <span class="hidden lg:inline">Buka Kiosk</span>
            </a>
        ...
        <div style="flex: 1; min-width: 0; height: 100vh; overflow-y: auto; display: flex; flex-direction: column;">
            <header style="height: 64px; min-height: 64px;" class="bg-white border-b border-gray-200 flex items-center px-6 lg:px-8 shrink-0">
                ...
                <h1 class="text-lg font-display font-bold text-gray-900"><?php echo e($pageTitle ?? ''); ?></h1>
...
<?php /**PATH C:\laragon\www\Luwene\resources\views/components/layouts/admin.blade.php ENDPATH**/ ?>