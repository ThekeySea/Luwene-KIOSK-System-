            ...
            <tbody class="divide-y divide-gray-100">
                @forelse ($staff as $member)
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-3 text-gray-600">{{ $member->branch->name ?? '-' }}</td>
                        <td class="px-4 py-3">
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <select wire:model="branch_id" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-900 focus:ring-2 focus:ring-primary outline-none">
