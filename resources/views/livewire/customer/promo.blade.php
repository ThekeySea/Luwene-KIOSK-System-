            ...
            <div class="bg-green-50 border-2 border-green-500 rounded-2xl p-5">
                <div class="flex items-start justify-between gap-3">
                    <div>
                        ...
                        <p class="text-xl font-display font-bold text-dark mt-1">{{ $applied->code }}</p>
                        <p class="text-sm text-warm-600 mt-1">{{ $applied->label() }}</p>
                    </div>
                    <span class="text-3xl">🎟️</span>
                </div>
                <div class="mt-4 flex gap-2">
                    <a href="{{ route('customer.cart') }}" class="flex-1 py-2.5 bg-green-600 text-white text-sm text-center font-semibold rounded-xl hover:bg-green-700 transition">
                        Lihat Nampan
                    </a>
