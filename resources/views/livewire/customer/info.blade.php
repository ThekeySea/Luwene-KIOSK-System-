<div class="min-h-dvh bg-warm-50">
    <header class="bg-white shadow-sm sticky top-0 z-10">
        <div class="max-w-3xl mx-auto px-4 py-4 flex items-center justify-between">
            <a href="{{ route('customer.cart') }}" class="text-warm-400 hover:text-dark transition">
    ...
    <main class="max-w-3xl mx-auto p-4">
        ...
        @else
            <div class="text-center py-16">
                ...
                <a href="{{ route('customer.menu') }}" class="inline-block px-6 py-2.5 bg-primary text-white rounded-xl font-semibold hover:bg-primary-700 transition">
                    Lihat Menu
                </a>
            </div>
        @endif
